...
public class CustomAdapter_Hide extends ArrayAdapter<items> {
    Context context;
    ArrayList<items> arrayList;
    int layoutResource;
    ArrayList<Integer> hide;

    public CustomAdapter_Hide(Context context, int resource, ArrayList<items> objects, ArrayList<Integer> hide) {
